...
// 2) 주요 목적: 복잡한 카드 / 대시 보드 / 갤러리 레이아웃 구성
// 3) 적용 대상: display: grid;를 가진 부모 컨테이너

//^ 기본 속성 정리
// display: grid;         - 그리드 컨테이너 활성화
// grid-empleate-columns  - 열 개수 / 크기 정의     EX) repeat(3, 1fr)
// grid-template-rows     - 행 개수 / 크기 정의
// gap                    - 아이템 간 간격
    ...
    <>
      ...
      <section>
        <div className={gridStyles.gridLayout}>
          <div className={gridStyles.items1}>1</div>
          <div className={gridStyles.items2}>2</div>
          <div className={gridStyles.items3}>3</div>
        </div>
      </section>
    </>
  );
