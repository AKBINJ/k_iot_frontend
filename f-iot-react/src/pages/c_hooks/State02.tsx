...
function State02() {
  ...
  const handleLoginChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setLogin({
      ...login, // id와 password 속성을 모두 가지는 login 객체 (현재의 값 가져오기)
      // id: '기존값,
      // password: '기존값'
  ...
  const handleLoginSubmin = (e: React.FormEvent) => {
  ...
  return (
    <div>
      ...
      <input 
        ...
        value={inputValue}
        // onChange 이벤트
        // : 사용자가 요소에 변화를 일으킬 때 마다 발생한느 이벤트
        // - input, select, texttarea 등의 요소에 적용
