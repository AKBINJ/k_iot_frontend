...
//? 제네릭 필요성
// : 코드 중복 줄임, 타입 안성성('컴파일' 시점에 타입 체크)

//? 제네릭 기본 문법
// : 사용할 컴포넌트(변수, 함수, 클래스 등)의 이름 뒤에 <>작성
// - 꺽쇠괄호 안에 타입 변수 지정

// cf) 타입 변수: 임의의 키워드 사용 (주로 T, U, V 등 대분자 한 글자로 표현)
...
let pari1 = pair<string, number>('hi', 123);
let pari2 = pair<number, string>(123, 'hi');
