...
// - 프로젝트의 의존성 관리 & 스크리븥 실행 기능을 제공

// == npm 기본 명령어 == //
// 1) npm init
//    : 새로운 Node.js 프로젝트 시작
//    - 기본값으로 package.js파일 생성
//    - npm init -y

/*
  {
    "name": "e_typescript", //? 프로젝트 이름 설정
    "version": "1.0.0",     //? 프로젝트 시작 버젼
    "description": "",      //? 프로젝트 간단한 설명
    "main": "index.js",     //? 진입점 JS 파일 (빌드 결과 기준)
    "scripts": {            //? npm run 명령어 정의
