...
//? 리터럴 타입의 종류
// 1) 해당 값만을 가지느 상수(const)
let str1 = '안녕'; // let str1: string
str1 = 'hello';
str1 = '곤니';

const str2 = '안녕'; // const str2: "안녕하세요" (리터럴 "안녕하세요" 타입)
// str2 = 'hello';
...
// cf) 리터널 타입을 활용한 유니언 타입 사용 시 여러 타입의 데이터 혼합 가능
...
function greet(person: Person) {
  console.log(`Nmme: ${person.name}, age: ${person.age}`);
}
...
//    , 카와 값의 타입만 정의하여 구조를 유연하게 적용하는 방법
