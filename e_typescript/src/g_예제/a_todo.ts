...
//^ 할 일 수정 함수 (완료 여부 토글)
function completedTodoo(todos: TodoItem[], id: number) {
  // 변화된 배열 (새로운 주소값 반환 - 변환 인지!)
...
todos = completedTodoo(todos, 1);
todos = completedTodoo(todos, 3);
todos = completedTodoo(todos, 4);
