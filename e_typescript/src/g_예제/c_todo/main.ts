...
class TaskManager<T> {
  ...
  renderTask(taskListId: string): void {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const newTaskInput = document.getElementById('task-input') as HTMLButtonElement;
