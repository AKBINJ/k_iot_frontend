/*
  ...
  - 함수형 프로그래밍 가능 (함수라는 문법이 존재)
    ...
    cf) 지바는 독립적인 함수 사용 불가 - 클래스 내의 메서드만 존재
*/ 
...
//! 2. 배열의 활용
//? 1) 요소 접근 & 수정
const sports = ['축구', '야구', '농구']; // 상수 (재할당 X)

// clg: console.log(); - snippet 기능


console.log(sports[1]); // 배열명[인데스번호]
...
// 1) indexOf(요소값): 찾는 요소의 첫 번쨰 인덱스를 반환 (없으면 -1)
...
//         unshift()  - 제일 첫 번쨰 요소부터 하나 이상의 요소를 추가 (+ 수정된 배열 길이를 반환)
