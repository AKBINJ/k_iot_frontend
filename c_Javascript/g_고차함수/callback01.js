...
// 일반 코드 흐름 로직
function callback1(callbackFunc) { // print 함수가 이자로 전달되면 callbackFunc 매개변수명으로 사용됨
  for (let i =0; i < 3; i++) {
...
const oddFunc = oddNum => console.log(`${oddNum} 값은 짝수입니다.`);

// function evenFunc(evenNum) {
//   console.log(`${evenFunc} 값은 짝수입니다.`);
// }
